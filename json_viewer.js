...
function viewObj( obj, root, objName ){
	...
	var el = (function listNode( node, nodeID ){
		...
		if( node === null ){
			...
			AE(NE("span",{"class":"nullVal", 'data-watch':nodeID, title: nodeID}, "null"), newEl);
		}
		else if( typeof node === "function" ) {
			AE(NE("span", {"class":"fncVal", 'data-watch':nodeID, title: nodeID}, "function(..){..}"), newEl);
			newEl.className = "endNode";
		}
			...
			if( typeof node === "string"){
				AE(NE("span",{"class":"strVal", 'data-watch':nodeID, title: nodeID}, "\"" + node + "\""), newEl);
			}else{
				AE(NE("span",{"class":"val", 'data-watch':nodeID, title: nodeID }, node), newEl);
			}
		}
		return newEl;
